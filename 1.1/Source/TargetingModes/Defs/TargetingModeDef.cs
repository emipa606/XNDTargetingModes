...
namespace TargetingModes
{
    public class TargetingModeDef : Def
    {
        ...
        public int RerollCount(Pawn pawn, Thing instigator)
        {
            ...
            BodyDefExtension extensionValues = pawn.RaceProps.body.GetModExtension<BodyDefExtension>();
            if (extensionValues != null && extensionValues.targetModeRerollCountFactors.ContainsKey(this))
